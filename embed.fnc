...
pb	|char*	|mem_collxfrm	|NN const char* input_string|Size_t len|NN Size_t* xlen
...
Apmb	|char*	|sv_2pv		|NN SV *sv|NULLOK Size_t *lp
...
Apmdb	|void	|sv_catpvn	|NN SV *dsv|NN const char *sstr|Size_t len
...
Apmdb	|void	|sv_insert	|NN SV *const bigstr|const Size_t offset \
...
Apd	|Size_t	|sv_pos_b2u_flags|NN SV *const sv|Size_t const offset \
				 |U32 flags
Apmdb	|char*	|sv_pvn_force	|NN SV* sv|NULLOK Size_t* lp
...
s	|UV	|_to_utf8_case  |const UV uv1					\
				...
				|NULLOK const char *special
#endif
Apbmd	|UV	|to_utf8_lower	|NN const U8 *p|NN U8* ustrp|NULLOK Size_t *lenp
AMp	|UV	|_to_utf8_lower_flags	|NN const U8 *p|NN U8* ustrp  \
				|NULLOK Size_t *lenp|bool flags
Apbmd	|UV	|to_utf8_upper	|NN const U8 *p|NN U8* ustrp|NULLOK Size_t *lenp
AMp	|UV	|_to_utf8_upper_flags	|NN const U8 *p|NN U8* ustrp   \
				|NULLOK Size_t *lenp|bool flags
Apbmd	|UV	|to_utf8_title	|NN const U8 *p|NN U8* ustrp|NULLOK Size_t *lenp
AMp	|UV	|_to_utf8_title_flags	|NN const U8 *p|NN U8* ustrp   \
				|NULLOK Size_t *lenp|bool flags
Apbmd	|UV	|to_utf8_fold	|NN const U8 *p|NN U8* ustrp|NULLOK Size_t *lenp
...
Apmdb	|Size_t	|sv_utf8_upgrade|NN SV *sv
