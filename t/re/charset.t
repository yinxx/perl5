...
push @{$testcases{'[:graph:]'}}, utf8::unicode_to_native($_) for (0xA2 .. 0xA6);
...
push @{$testcases{'[:graph:]'}}, utf8::unicode_to_native($_) for (0xAC .. 0xB4);
...
push @{$testcases{'[:upper:]'}}, utf8::unicode_to_native($_) for (0xC0 .. 0xD6);
push @{$testcases{'[:graph:]'}}, utf8::unicode_to_native(0xD7);
push @{$testcases{'[:upper:]'}}, utf8::unicode_to_native($_) for (0xD8 .. 0xDE);
push @{$testcases{'[:lower:]'}}, utf8::unicode_to_native($_) for (0xDF .. 0xF6);
push @{$testcases{'[:graph:]'}}, utf8::unicode_to_native(0xF7);
push @{$testcases{'[:lower:]'}}, utf8::unicode_to_native($_) for (0xF8 .. 0xF8);
